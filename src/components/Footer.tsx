...
const Footer: React.FC = () => {
  return (
    <div className='bg-[rgb(230,212,255)] p-8 text-[rgb(57,45,130)]'>
      <div className='flex flex-col lg:flex-row justify-evenly'>
        <div className='space-y-2 lg:w-1/3'>
          ...
          <p className='tracking-tighter w-1/2 text-sm'>{footerData.address.description}</p>
      ...
      <hr className='h-px my-4 bg-grey-400' />
